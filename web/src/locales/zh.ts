...
[在此处插入文本]`,
    ...
    scanDirectory: {
      ...
      directoryPath: '目录路径',
      scanInterval: '扫描间隔',
      previouslyScanned: '已扫描目录',
      lastScan: '上次扫描',
      never: '从未扫描',
      interval: '间隔',
      note: '注意：此功能从服务器的本地文件系统扫描文件。',
      pathPlaceholder: '/path/to/directory',
      scan: '扫描',
      cancel: '关闭',
      delete: '删除',
      noDirectoriesScanned: '尚未扫描任何目录',
      ...
      everyWeek: '每周',
      every4Weeks: '每4周',
      successfullyScanned: '成功扫描 {{count}} 个文件',
      noFilesFound: '指定路径中未找到文件',
      failedToScan: '扫描路径失败',
      directoryRemoved: '目录已从扫描列表中移除',
      failedToDelete: '删除失败',
      intervalUpdated: '扫描间隔已更新',
      failedToUpdate: '更新失败',
      confirmDelete: '确定要从扫描列表中移除此目录吗？',
      confirmDeleteTitle: '确认删除',
      duplicatePathTitle: '重复路径',
      duplicatePathMessage:
        '该路径已添加到扫描列表中。请使用其他路径或先将其从列表中移除。',
    },
    sourceLocal: '本地上传',
    sourceLocalPath: '本地扫描',
  },
};
