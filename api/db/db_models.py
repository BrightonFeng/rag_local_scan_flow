...
class ScannedDirectory(DataBaseModel):
    id = CharField(max_length=32, primary_key=True)
    kb_id = CharField(max_length=256, null=False, index=True)
    directory_path = TextField(null=False, help_text="Directory path to scan")
    scan_interval_minutes = IntegerField(default=60, help_text="Scan interval in minutes")
    last_scan_time = DateTimeField(null=True, help_text="Last scan time")
    created_by = CharField(max_length=32, null=False, help_text="who created it")
    created_at = DateTimeField(null=False, help_text="created time")

    class Meta:
        db_table = "scanned_directory"
...
class Document(DataBaseModel):
    ...
    location = CharField(max_length=1024, null=True, help_text="where dose it store", index=True)
